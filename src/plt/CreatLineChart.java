...
//           frame.setLocationRelativeTo(null);
        try {
            ...
            // 柱子名称：柱子所有的值集合
            //纵坐标
            series.add(new Serie("Player Name", new Double[] { 49.9,50.0,41.0,52.0,54.0,57.0,54.0,53.2,47.6 ,54.0,53.2,47.6 }));

            ChartPanel  chartPanel = new CreatLineChart().createChart("lol.png", "场次", "胜率", categorie,series);
//            frame.getContentPane().add(chartPanel);
//            frame.setVisible(true);
            //将图片保存为png格式
            //saveAsFile(chartPanel.getChart(),"D:\\1\\lol2.png",900,500);
            CreateNewLineChartForPng("dota", "场次", "胜率", "D:\\1\\lol.png", categorie, series, 900, 500);
